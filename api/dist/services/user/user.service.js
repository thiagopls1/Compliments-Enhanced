...
let UserService = class UserService {
    ...
    async create(createUserDto) {
        if (await this.userRepository.findOneBy({ userName: createUserDto.userName }))
            throw new common_1.HttpException(`Username ${createUserDto.userName} already used`, common_1.HttpStatus.BAD_REQUEST);
        if (await this.userRepository.findOneBy({ email: createUserDto.email }))
            throw new common_1.HttpException(`Email ${createUserDto.email} already used`, common_1.HttpStatus.BAD_REQUEST);
